...
<br>
Start by either creating a directory called `r4grads`` and downloading the data from Github or clone the Github repository for this workshop. How to do this and then appropriately set the working directory is detailed in the section on importing data in base R.       EDIT THIS 
