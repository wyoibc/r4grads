...
Note that you can achieve all of the same ends without Tidyverse functions using R's basic indexing, e.g., you could alternately get only S. occidentalis rows by running:
