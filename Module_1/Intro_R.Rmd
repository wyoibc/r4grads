...
* Note that while you'll occasionally create vectors or other types of objects from scratch, most of the time you'll reading data into R from a file, we'll get into that in the next session.
